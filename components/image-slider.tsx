    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-blue-500 to-purple-600">
      <div className="w-full max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-4">
        <h1 className="text-4xl font-bold text-center mb-4">
          ...
          <span className="text-purple-600">Slider</span>
        </h1>
          ...
          <CarouselContent>
            {images.map((image, index) => (
              ...
              >
                ...
                />
                <div className="p-4 bg-white/80 text-center rounded-b-lg shadow-md">
                  <h2 className="text-lg font-bold text-gray-900">{image.user.name}</h2>
